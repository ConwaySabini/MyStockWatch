                        ...
                        <br />
                        {
                            renderGainers ? (
                                <p class="menu-label">
                                    ...
                                    <a onClick={() => hideList("gainers")} href="">
                                ...
                                <p class="menu-label">
                                    <strong id="menu-label">Gainers</strong>
                                    <a onClick={() => showList("gainers")} href="">
                        ...
                        }
                        {
                            renderLosers ? (
                                <p class="menu-label">
                                    ...
                                    <a onClick={() => hideList("losers")} href="">
                                        <FontAwesomeIcon id="angle-down-menu" icon={faAngleDown} size="2x" />
                                    </a>
                                    <p id="losers">
                                        {
                                ...
                                <p class="menu-label">
                                    <strong id="menu-label">Losers</strong>
                                    <a onClick={() => showList("losers")} href="">
                                        <FontAwesomeIcon id="angle-down-menu" icon={faAngleUp} size="2x" />
                                    </a>
                                </p>
                            )
                        }
                        {
                            renderFavorites ? (
                                <p class="menu-label">
                                    ...
                                    <a onClick={() => hideList("favorites")} href="">
                                        <FontAwesomeIcon id="angle-down-menu" icon={faAngleDown} size="2x" />
                                    </a>
                                    <p id="favorites">
                                        {
                                ...
                                <p class="menu-label">
                                    <strong id="menu-label">Favorites</strong>
                                    <a onClick={() => showList("favorites")} href="">
                                        <FontAwesomeIcon id="angle-down-menu" icon={faAngleUp} size="2x" />
                                    </a>
                                </p>
                            )
